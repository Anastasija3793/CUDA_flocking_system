...
//----------------------------------------------------------------------------------------------------------------------
/// @brief in the alignment rule don't use applyForce in order to achieve fireflies effect as well as the weight
/// is set lower than in other rules
//----------------------------------------------------------------------------------------------------------------------
void Flock::align()
{
    for(int i=0; i<m_numBoids; ++i)
...
//----------------------------------------------------------------------------------------------------------------------
/// @brief writes/dumps geo into houdini geo files
/// from: https://github.com/rsouthern/libfluid/blob/master/test/src/main.cpp
//----------------------------------------------------------------------------------------------------------------------
